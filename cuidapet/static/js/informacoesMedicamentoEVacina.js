    ...
    if (nomesPets.length > 0) {
        nomesPets.forEach(nome => {
            ...
            li.addEventListener("click", function () {
                ...
                document.getElementById("medicamento_pet").textContent = pet.ultimoMedicamento?.nome || "Não registrado";
                document.getElementById("data_medicamento").textContent = pet.ultimoMedicamento?.data || "-";
                document.getElementById("vacina_pet").textContent = pet.ultimaVacina?.nome || "Não registrada";
                document.getElementById("data_vacina").textContent = pet.ultimaVacina?.data || "-";
